...
int mainBench(cl_device_id* device_id){
	...
	benchClefia128Multiple(100000, localSize, 2,device_id);
	benchClefia192Multiple(100000, localSize, 2,device_id);
	benchClefia256Multiple(100000, localSize, 2,device_id);
